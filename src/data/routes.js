...
export const saturdayRoute = [
  {
    ...
    time: "5:45 AM",
    timeMinutes: 5 * 60 + 45,
    label: "Be in line at Colman Dock",
    description: "Home → ferry line",
    directionMode: "driving",
    directionUrl: "https://www.google.com/maps/dir/?api=1&origin=7353%2019th%20Ave%20NW%2C%20Seattle%29&destination=Colman%20Dock%2C%20801%20Alaskan%20Way%2C%20Seattle%2C%20WA&travelmode=driving",
  },
  {
    type: "ferry",
    id: "ferry-seattle-bremerton",
    time: "6:05 AM",
    timeMinutes: 6 * 60 + 5,
    label: "Seattle → Bremerton Ferry",
    description: "60 min crossing — be in line by 5:45 AM!",
    ferryFrom: "Colman Dock, Seattle",
    ferryTo: "Bremerton Ferry Terminal",
    duration: 60,
    departTime: "6:05 AM",
    arriveTime: "7:05 AM",
    lineupBy: "5:45 AM",
  ...
  },
  {
    ...
    time: "8:00 AM",
    timeMinutes: 8 * 60,
    travelFrom: "Bremerton ferry terminal",
    travelTime: "Walk from ferry",
    directionMode: "walking",
    directionUrl: "https://www.google.com/maps/dir/?api=1&origin=Bremerton%20ferry%20terminal%2C%20Washington%20Ave%2C%20Bremerton%2C%20WA&destination=409%20Pacific%20Ave%2C%20Bremerton%2C%20WA&travelmode=walking",
  },
  {
    type: "store",
    id: "awaywithwords",
